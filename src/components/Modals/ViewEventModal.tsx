       ...
       <div
        ...
        >
          ...
          <div className="py-10 px-5">
            <p>
              Event: <span className="font-bold ml-2">{modalStore.viewEvent.event_name}</span>
            </p>
            <p>
              Location: <span className="font-bold ml-2">{modalStore.viewEvent.event_location}</span>
            </p>
            <p>
              Date: <span className="font-bold ml-2">{moment(modalStore.viewEvent.event_date).calendar()}</span>
            </p>
            <p>
              Host: <span className="font-bold ml-2">{modalStore.viewEvent.host}</span>
            </p>
          </div>
          <Image
            src="/x.svg"
