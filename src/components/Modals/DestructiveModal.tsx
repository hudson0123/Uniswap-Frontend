        ...
        >
          ...
          <div className="flex flex-col-2 mt-auto">
            ...
            <button
              ...
              className="relative h-8 w-20 mt-auto ml-2 bg-red-500 hover: hover:bg-red-400 text-nowrap text-white py-1 px-4 rounded-lg transition duration-100 cursor-pointer"
            >
